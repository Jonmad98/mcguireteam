       ...
       <section class="container banner-principal">
        ...
        <div class="texto-banner">
          <?php if (is_category()): ?>
              ...
              <h3><?php _e('Category: ','slan');?> <?php single_cat_title(); ?></h3>

            <?php elseif (is_tag() ): ?>

              <h3><?php _e('Tags: ','slan');?> <?php single_tag_title(); ?></h3>

            <?php elseif (is_search() ): ?>

              <h3><?php _e('Search results for: ','slan');?> <?php the_search_query(); ?></h3>

            <?php elseif (is_day() ): ?>

              <h3><?php _e('Archive : ','slan');?> <?php the_time(get_option('date_format'));  ?></h3>

            <?php elseif (is_month() ): ?>

              <h3><?php _e('Archive : ','slan');?> <?php the_time('F Y');  ?></h3>

            <?php elseif (is_year() ): ?>

              <h3><?php _e('Archive : ','slan');?> <?php the_time('Y');  ?></h3>

            <?php elseif (is_author() ): ?>

              <h3><?php _e('articles of: ','slan');?>
                <?php
            ...
            <?php elseif (is_404() ): ?>
              ...
              <h3><?php _e('Page Not Found ','slan');?></h3>
                      ...
                      <div class="navegacion-articulos">
                          <nav>
                            <div class="anterior">
                              ...
                              <?php next_posts_link(__('<i class="fa fa-arrow-left" aria-hidden="true"></i> Previous Posts','slan')); ?>
                            </div>
                            <div class="siguiente">

                              <?php previous_posts_link(__('Recent Posts <i class="fa fa-arrow-right" aria-hidden="true"></i>','slan')); ?>
                            </div>
                          </nav>
